...
void parseArgument(int argc, char *argv[], FILE **file, bus_t *bus);
int execute(char *content, stack_t **head, unsigned int counter, FILE *file, bus_t *bus);
void free_stack(stack_t *head);

void cleaning(stack_t **head, bus_t *bus);
void executeOpcode(char *opcode, char *arg_str, stack_t **head, unsigned int counter, bus_t *bus);
char *parseOpcode(char *content, bus_t *bus, unsigned int counter);
